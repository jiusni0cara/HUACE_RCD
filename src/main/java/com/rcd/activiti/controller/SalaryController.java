package com.rcd.activiti.controller;

import com.rcd.activiti.domain.SalaryDO;
import com.rcd.activiti.service.SalaryService;
import com.rcd.activiti.utils.ActivitiUtils;
...
public class SalaryController extends BaseController{
    ...
    public R saveOrUpdate(SalaryDO salary) {
        if (demoNotAllowed()) return R.error(1, "演示系统不允许修改,完整体验请部署程序");
    ...
    private boolean demoNotAllowed() {
