...
import com.rcd.system.dao.RoleDao;
import com.rcd.system.dao.RoleMenuDao;
import com.rcd.system.dao.UserDao;
import com.rcd.system.dao.UserRoleDao;
import com.rcd.system.domain.RoleDO;
import com.rcd.system.domain.RoleMenuDO;
...
public class RoleServiceImpl implements RoleService {
    ...
    @Override
    public HSSFWorkbook export(List<RoleDO> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            row.createCell(0).setCellValue(roleDO.getRoleName());
        }
        return wb;
    }
}
